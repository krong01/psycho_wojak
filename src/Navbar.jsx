  ...
  return (
    <div className="fixed top-[60px] left-1/2 transform -translate-x-1/2 z-30 flex space-x-20">
        ...
        <img
          src={title7}
          alt="Nav 6"
          className="max-w-15 max-h-full hover:scale-110 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_12px_rgba(255,215,0,0.9)]"
          onClick={() => handleClick('/')}
        />
      </div>
      <div
      ...
      >
        <img
          src={title1}
          alt="Nav 1"
          className="max-w-20 max-h-full hover:scale-110 transition-transform duration-300 hover:drop-shadow-[0_0_12px_rgba(255,215,0,0.9)]"
        />
      </div>
      <div className="w-14 h-14 flex items-center justify-center floating2">
        <img
          src={title2}
          alt="Nav 2"
          className="max-w-18 max-h-auto hover:scale-110 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_12px_rgba(255,215,0,0.9)]"
      ...
      <div className="w-16 h-16 flex items-center justify-center floating3">
        <img
          src={title3}
          alt="Nav 3"
          className="max-w-25 max-h-full hover:scale-110 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_12px_rgba(255,215,0,0.9)]"
          onClick={() => handleClick('/page3')}
        />
      </div>
      <div className="w-15 h-15 flex items-center justify-center floating4">
        <img
          src={title4}
          alt="Nav 4"
          className="max-w-full max-h-full hover:scale-110 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_12px_rgba(255,215,0,0.9)]"
          onClick={() => handleClick('/page4')}
        />
      </div>
      <div className="w-16 h-16 flex items-center justify-center floating5">
        <img
          src={title5}
          alt="Nav 5"
          className="max-w-full max-h-full hover:scale-110 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_12px_rgba(255,215,0,0.9)]"
